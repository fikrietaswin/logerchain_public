...
/**
 * A button that triggers the select to open.
 */
...
/**
 * A button to scroll up in the select content.
 */
...
/**
 * A button to scroll down in the select content.
 */
...
/**
 * The main content of the select.
 */
