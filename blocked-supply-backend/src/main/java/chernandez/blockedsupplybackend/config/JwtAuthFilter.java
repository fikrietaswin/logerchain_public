...
import chernandez.blockedsupplybackend.services.JwtService;
...
/**
 * A filter that authenticates requests using JWT.
 * <p>
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (request.getServletPath().contains("/auth")) {
            System.out.print("authHeader: " + request.getServletPath());
        ...
        if (user.isEmpty()) {
            System.out.print("user empty: " + user);
            filterChain.doFilter(request, response);
            return;
        }
        ...
        if (!isTokenValid) {
            System.out.print("isTokenValid: " + isTokenValid);
            return;
        }
